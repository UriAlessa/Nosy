...
const MenuResponsive = (props) => {
    ...
    return (
        <div className={styles.menuResponsive}>
            <svg onClick={showMenu} xmlns="http://www.w3.org/2000/svg" className={styles.equisResponsive} fill="currentColor" viewBox="0 0 16 16">
            ...
            <nav>
                ...
                <a onClick={showMenu} href="#howToPlay">HOW TO PLAY</a>
