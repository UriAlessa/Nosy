  ...
  return (
    <section id="whatTheySaying" className={styles.section}>
      ...
      <div className={styles.containerSection}>
        <div className={styles.columnSection}>{render}</div>
...
const AllReviews = [
  {
    ...
    funnyRate:
      "" /**número que se transformará en icono de diversión del 1 al 5*/,
    learningRate:
      "" /*otracosa*número que se transformará en icono de aprehendizaje del 1 al 5*/,
    interactiveRate:
      "" /**estos números deberían ir a parar al ranking general, pero ser tomados desde cada usuario */,
    intuitiveRate:
      "" /**puntaje de cuán intuitivo le pareció al jugar por primera vez */,
